...
{
    public class EventsArchivosConsultasOficialPartesEvents
    {
       ...
       public static void UpdateWithFile(
        ...
        public static ArchivoConsulta GetRolOficialPartes()
        {
            ArchivoConsulta entity = new()
            {
                id_rol = 3
        ...
        public static ArchivoConsulta CreateDocumentoCumplimentacion(
            string noAsunto,
            int? id_tipo_documento,
            int id_seccion,
            int id_administracion,
