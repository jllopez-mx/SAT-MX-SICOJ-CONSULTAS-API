...
{
    public class ConsultasRepositoryAdministrador : IConsultaRepositoryAdministrador
    {
        #region Variables
        ...
        #region Constructor
        public ConsultasRepositoryAdministrador(ISqlTools database)
        {
            _database = database ?? throw new ArgumentNullException(nameof(database));
        }
        #endregion

        public async Task<List<ResponseConsultaByFilters>> GetBandejaPendientesAsyncRepositoryAdministrador(
           int pageSize,
           int page,
       ...
       )
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnunFunctions.CONSULTA_LISTADO_CONSULTAS_BANDEJA_PENDIENTES_ADMINISTRADOR,
                parameters!
             );
        ...
        public async Task<int?> GetAllByFiltersCountAsyncRepositoryAdministrador(
        List<int>? TipoAsunto,
        int? idUnidadAdmistrativaCentral = null!,
        int? idUnidadAdmistrativa = null!
      )
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnunFunctions.ConsultasByFiltersCount_Pendientes_Administrador,
                parameters!
            );
            if (response.ExisteError)
            {
        ...
        )
        {
            ...
            PersonasAutorizadas entity = EventsConsultasAdministrador.GetPersonasAutorizadasAdministrador();
        ...
        public async Task<ResponseConsultaByFilters> GetByIdRepositoryAdministrador(int id)
        {
            ParameterPGsql[] parameters =
            {
                new ParameterPGsql("p_id", NpgsqlDbType.Integer, id),
            ...
            return new()
            {
                ...
                fechaVencimiento = response.Data.Tables[0].Rows[0].IsNull(14) ? null! : response.Data.Tables[0].Rows[0].Field<DateTime>(14).ToString("yyyy-MM-dd"),
                ...
                idEmpleado = response.Data.Tables[0].Rows[0].IsNull(25) ? null! : response.Data.Tables[0].Rows[0].Field<string>(25),
                fechaTurnado = response.Data.Tables[0].Rows[0].IsNull(26) ? null! : response.Data.Tables[0].Rows[0].Field<DateTime>(26).ToString("yyyy-MM-dd"),
                remitido = response.Data.Tables[0].Rows[0].IsNull(27) ? false : response.Data.Tables[0].Rows[0].Field<bool>(27),
                idAlerta = response.Data.Tables[0].Rows[0].IsNull(31) ? 0 : response.Data.Tables[0].Rows[0].Field<int>(31),
                alerta = response.Data.Tables[0].Rows[0].IsNull(32) ? null! : response.Data.Tables[0].Rows[0].Field<string>(32)!,
        ...
        {
            ArchivoConsulta entity = EventsArchivosConsultasAdministrador.GetRolAdministrador();

            ParameterPGsql[] parameters =
          {
                new ParameterPGsql("p_id_rol", NpgsqlDbType.Integer, entity.id_rol),
                new ParameterPGsql("p_id_remision", NpgsqlDbType.Integer, id_registro!),
        ...
        )
        {
            ...
            ParameterPGsql[] parameters =
            {
                ...
                new ParameterPGsql("p_id_unidad_administrativa_central", NpgsqlDbType.Integer, idUnidadAdmistrativaCentral),
                new ParameterPGsql("p_id_unidad_administrativa", NpgsqlDbType.Integer, idUnidadAdmistrativa),
                new ParameterPGsql("p_reasignar_asuntos", NpgsqlDbType.Boolean, reasignarAsuntos),
            };

            var response = await _database.ExecuteFunctionAsync(
                EnunFunctions.ConsultasHistoricoCountAdmin,
                parameters!
            );
            if (response.ExisteError)
            {
        ...
        public async Task<List<ResponseConsultaByFiltersAdministrador>> GetHistoricoAsyncRepository(
              int pageSize,
              int page,
              string? orderByColumn,
              bool orderDesc,
          ...
          )
        {
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnunFunctions.CONSULTA_HISTORICO_ADMIN,
                parameters!
            );
            if (response.ExisteError)
            {
            ...
            foreach (DataRow item in response.Data.Tables[0].Rows)
            {
                resultList.Add(
                    new()
                    {
                        ...
                        asignado = item.IsNull(31) ? false : item.Field<bool>(31),
                        idAbogado = item.IsNull(32) ? null! : item.Field<string>(32),
                        abogado = item.IsNull(33) ? null! : item.Field<string>(33),
                        idSeccionModificar = item.IsNull(34) ? 0 : item.Field<int>(34),
                        idColorFechacssj = item.IsNull(35) ? 0 : item.Field<int>(35),
        ...
        public async Task<ResultTransaction> UpdateAsyncSolicitudInformacion(SolicitudInformacion entity)
        {
            ParameterPGsql[] parameters =
            {
                new ParameterPGsql("p_id", NpgsqlDbType.Integer, entity.id!),
                new ParameterPGsql("p_id_consulta", NpgsqlDbType.Integer, entity.id_consulta!),
                new ParameterPGsql("p_id_unidad_administrativa", NpgsqlDbType.Integer, entity.id_consulta!),
                new ParameterPGsql("p_no_oficio_solicitud", NpgsqlDbType.Varchar, entity.no_oficio_solicitud!),
        ...
        public async Task<ResultTransaction> AddAsyncResolucion(Resolucion entity, ArchivoConsulta entityDocumento, DataFile dataFile) //Aqui
        {
        ...
        public async Task<ResultTransaction> AsignarCumplimentacionRepository(Cumplimentacion entity)
        {
            ParameterPGsql[] parameters =
            {
                new ParameterPGsql("p_id_cumplimentacion", NpgsqlDbType.Integer, entity.id),
                new ParameterPGsql("p_id_abogado", NpgsqlDbType.Text, entity.id_abogado!),
            ...
            var response = await _database.ExecuteFunctionAsync(
                EnunFunctions.CONSULTA_ASIGNAR_CUMPLIMENTACION,
                parameters
            );
            if (response.ExisteError)
            {
        ...
        public async Task<List<ResponseMediosDefensa>> GetTablaMediosDefensaAsyncRepository(List<string> noAsunto)
        {

            ParameterPGsql[] parameters =
          {

                new ParameterPGsql("p_noasunto", NpgsqlDbType.Array | NpgsqlDbType.Text, (noAsunto is null || !noAsunto.Any()) ? DBNull.Value :  noAsunto.ToArray()),
            };


            var response = await _database.ExecuteFunctionAsync(
                EnunFunctions.GetTablaMediosDefensa,
                     parameters!
             );
            if (response.ExisteError)
            {
            ...
            foreach (DataRow item in response.Data.Tables[0].Rows)
            {
                resultList.Add(
                    new()
                    {
                        asunto = response.Data.Tables[0].Rows[0].IsNull(1) ? null! : response.Data.Tables[0].Rows[0].Field<string>(1),
                        medioDefensa = response.Data.Tables[0].Rows[0].IsNull(2) ? null! : response.Data.Tables[0].Rows[0].Field<string>(2),
                        unidadControlaAsunto = response.Data.Tables[0].Rows[0].IsNull(4) ? null! : response.Data.Tables[0].Rows[0].Field<string>(4)!,
                        estadoProcesal = response.Data.Tables[0].Rows[0].IsNull(10) ? null! : response.Data.Tables[0].Rows[0].Field<string>(10)!,
                    }
                );
            }
        ...
        public async Task<List<Response_Resolucion_PDF>> ExportarPDFAsyncRepository(string noAsunto)
        {
            ...
            List<Response_Resolucion_PDF> resultList = new();
            ...
            foreach (DataRow item in response.Data.Tables[0].Rows)
            {
                resultList.Add(
                    new()
                    {
                        administracion = response.Data.Tables[0].Rows[0].IsNull(0) ? null! : response.Data.Tables[0].Rows[0].Field<string>(0)!,
                        no_asunto = response.Data.Tables[0].Rows[0].IsNull(1) ? null! : response.Data.Tables[0].Rows[0].Field<string>(1),
                        rfc = response.Data.Tables[0].Rows[0].IsNull(2) ? null! : response.Data.Tables[0].Rows[0].Field<string>(2)!,
                        promovente = response.Data.Tables[0].Rows[0].IsNull(3) ? null! : response.Data.Tables[0].Rows[0].Field<string>(3),
                        rfc_contribuyente = response.Data.Tables[0].Rows[0].IsNull(4) ? null! : response.Data.Tables[0].Rows[0].Field<string>(4)!,
                        contribuyente = response.Data.Tables[0].Rows[0].IsNull(5) ? null! : response.Data.Tables[0].Rows[0].Field<string>(5)!,                        //Asignación       
                        abogado = response.Data.Tables[0].Rows[0].IsNull(6) ? null! : response.Data.Tables[0].Rows[0].Field<string>(6)!,
                        sentido = response.Data.Tables[0].Rows[0].IsNull(7) ? null! : response.Data.Tables[0].Rows[0].Field<string>(7)!,
