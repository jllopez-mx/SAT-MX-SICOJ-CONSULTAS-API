...
{
    public class ConsultasRepositorySupervisor : IConsultaRepositorySupervisor
    {
        #region Variables
        ...
        public ConsultasRepositorySupervisor(ISqlTools database)
        {
  ...
  int? idDocumentoSeccion
        ...
        public async Task<List<ResponseMediosDefensa>> GetTablaMediosDefensaAsyncRepository(string noAsunto)
        {

            ParameterPGsql[] parameters =
          {
                new ParameterPGsql("p_noasunto", NpgsqlDbType.Text, noAsunto)
            };
