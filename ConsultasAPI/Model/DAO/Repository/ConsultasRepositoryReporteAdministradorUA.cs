...
{
    public class ConsultasRepositoryReporteAdministradorUA : IConsultaRepositoryReporteAdministradorUA
    {
        ...
        public ConsultasRepositoryReporteAdministradorUA(ISqlTools database)
        {
