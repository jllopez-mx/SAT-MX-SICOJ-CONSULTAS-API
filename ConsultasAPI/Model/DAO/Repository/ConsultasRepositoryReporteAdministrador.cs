...
{
    public class ConsultasRepositoryReporteAdministrador : IConsultaRepositoryReporteAdministrador
    {
        #region Variables
        ...
        public ConsultasRepositoryReporteAdministrador(ISqlTools database)
        {
