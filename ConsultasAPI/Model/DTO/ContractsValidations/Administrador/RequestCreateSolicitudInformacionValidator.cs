...
{
    public class RequestCreateSolicitudInformacionValidator: AbstractValidator<RequestCreateSolicitudInformacion>
    {
         public RequestCreateSolicitudInformacionValidator()
        {
