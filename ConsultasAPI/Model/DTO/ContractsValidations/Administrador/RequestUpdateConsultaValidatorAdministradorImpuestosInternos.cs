...
{
    public class RequestUpdateConsultaValidatorAdministradorImpuestosInternos : AbstractValidator<RequestUpdateConsultaAdministradorImpuestosInternos>
    {
        public RequestUpdateConsultaValidatorAdministradorImpuestosInternos()
        {
