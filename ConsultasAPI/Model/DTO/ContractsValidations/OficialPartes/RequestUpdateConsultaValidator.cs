...
{
    public class RequestUpdateConsultaValidator :AbstractValidator<RequestUpdateConsulta>
    {
        public RequestUpdateConsultaValidator ()
        {
            RuleFor(c => c.rfc)
                .NotNull()
                .NotEmpty()
            ...
            RuleFor(c => c.promovente)
                ...
                .WithMessage("El parametro de promovente no tiene el formato correcto");
            ...
            RuleFor(c => c.despachoAutorizado)
                .NotNull()
                .WithMessage("No ha indicado el parametro de despacho_autorizado");
