...
{
    public class RequestUpdateSolicitudTransparenciaValidator: AbstractValidator<RequestUpdateSolicitudTransparencia>
    {
        public RequestUpdateSolicitudTransparenciaValidator()
        {
