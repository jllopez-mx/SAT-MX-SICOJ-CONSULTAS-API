...
{
    public class RequestCreateRequerimientoProdeconValidator : AbstractValidator<RequestCreateRequerimientoProdecon>
    {
        public RequestCreateRequerimientoProdeconValidator()
        {
            ...
            RuleFor(c => c.noExpedienteRequerimiento)
                .NotEmpty()
                .WithMessage("No ha indicado el parámetro de número de oficio.")
                .Matches(@"^[A-Za-z0-9/()-]*$")
                .WithMessage("El número de oficio contiene caracteres no permitidos. Solo se permiten letras, números, diagonal (/), guion medio (-) y paréntesis ().")
