...
{
    public class RequestUpdateConsultaValidatorAbogadoComercioExterior:AbstractValidator<RequestUpdateConsultaAbogadoComercioExterior>
    {
         public RequestUpdateConsultaValidatorAbogadoComercioExterior ()
        {
